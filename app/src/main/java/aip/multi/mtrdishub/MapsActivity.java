...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref = FirebaseDatabase.getInstance().getReference("MYLOCATION1");
        geoFire = new GeoFire(ref);

        toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setTitle("M-TR Dishub");
    ...
    private void removegeofence() {
        ...
        if (circle != null) {
            ...
            alertDialog.setTitle("M-TR Dishub").setIcon(R.drawable.icon);
            alertDialog.setMessage("Zona Pantau Dihapus.").setPositiveButton("OK", null);
            alertDialog.show();
        } else {
            AlertDialog.Builder alertDialog = new AlertDialog.Builder(MapsActivity.this);
            alertDialog.setTitle("M-TR Dishub").setIcon(R.drawable.icon);
            alertDialog.setMessage("Tidak Ada Zona Pantau.").setPositiveButton("OK", null);
            alertDialog.show();
        }
    }
    ...
    private void creategeofence() {
        ...
        if (mLastLocation != null && flag) {
            ...
            AlertDialog.Builder alertDialog = new AlertDialog.Builder(MapsActivity.this);
            alertDialog.setTitle("M-TR Dishub").setIcon(R.drawable.icon);
            alertDialog.setMessage("Zona Pantau Ditambahkan.").setPositiveButton("OK", null);
            alertDialog.show();
            //Add GeoQuery here
            ...
            AlertDialog.Builder alertDialog = new AlertDialog.Builder(MapsActivity.this);
            alertDialog.setTitle("M-TR Dishub").setIcon(R.drawable.icon);
            alertDialog.setMessage("Mohon Hapus Zona Lama.").setPositiveButton("OK", null);
            alertDialog.show();
        }
    }
    private void searchLocation(String location) {
        if (location != null) {
            ...
            if (list.size() > 0) {
                ...
                Toast.makeText(MapsActivity.this, "Tidak Ada Zona: " + location, Toast.LENGTH_LONG).show();
            }
        } else {
    ...
    private void GeoQueryFunction(final LatLng area) {
        ...
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                sendNotification("Anggota", String.format("%s Telah Tiba di Zona Pantau", key));
                SmsManager.getDefault().sendTextMessage(phone_number, null, "Anggota tiba di area, bisa di check disini \nhttp://maps.google.com?q=" + area.latitude + "," + area.longitude, null, null);

            }

            @Override
            public void onKeyExited(String key) {
                sendNotification("Anggota", String.format("%s Jauh dari Zona Pantau", key));
                SmsManager.getDefault().sendTextMessage(phone_number, null, "Anggota Jauh dari area, bisa di check disini \nhttp://maps.google.com?q=" + area.latitude + "," + area.longitude, null, null);
            }

            @Override
            public void onKeyMoved(String key, GeoLocation location) {
                Log.d("Sedang Berjalan", String.format("%s Sedang berjalan ke Zona Pantau [%f/%f]", key, location.longitude, location.longitude));
            }
    ...
    private void displayLocation() {
        ...
        if (mLastLocation != null) {
            ...
            final double longitude = mLastLocation.getLongitude();
            //Update To Firebase
            geoFire.setLocation("Anggota", new GeoLocation(latitude, longitude), new GeoFire.CompletionListener() {
                @Override
                public void onComplete(String key, DatabaseError error) {
                    ...
                    //remove old marker
                    mCurrent = mMap.addMarker(new MarkerOptions().position(new LatLng(latitude, longitude)).title("Kamu Disini"));
                    //Move Camera to this Position
                    mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(latitude, longitude), 15.0f));
                }
            });
            Log.d("M-TR Dishub", String.format("Lokasi telah berubah %f/ %f", latitude, longitude));
        } else
            Log.d("M-TR Dishub", "Lokasi diluar jangkauan");
    }
