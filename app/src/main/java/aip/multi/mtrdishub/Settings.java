            ...
            public boolean onMenuItemClick(MenuItem item)
            {
                switch (item.getItemId()) {
                    case R.id.goback:
                        ...
                        inumber = phone_number.getText().toString();
                        if (iradius.length() == 0) {
                            Toast.makeText(Settings.this, "Radius Mohon Diisi!", Toast.LENGTH_SHORT).show();
                        } else if (inumber.length() == 0) {
                            Toast.makeText(Settings.this, "Nomor Telepon Mohon Diisi!", Toast.LENGTH_SHORT).show();
                        } else if (inumber.length() > 0 && inumber.length() < 10) {
                            Toast.makeText(Settings.this, "Nomor Tidak Sesuai!", Toast.LENGTH_SHORT).show();
                        }
